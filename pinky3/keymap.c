...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_TABHOU] = LAYOUT( \
  //,---------------------------------------------------------------------.  ,---------------------------------------------------------------------.
        KC_ESC,     KC_Q,     KC_H,     KC_O,     KC_U,  KC_QUOT,  _______,     _______,  KC_SCLN,     KC_F,     KC_R,     KC_N,     KC_J,   KC_DEL,\
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
        KC_DOT,     KC_Y,     KC_I,     KC_E,     KC_A,     KC_Z,  _______,     _______,     KC_C,     KC_S,     KC_T,     KC_L,     KC_W,  KC_COMM,\
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
        KC_END,     KC_V,     KC_B,     KC_X,     KC_K,   KC_TAB,  KC_LGUI,     KC_RGUI,  KC_BSPC,     KC_D,     KC_M,     KC_P,     KC_G,   KC_ENT,\
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
  ...
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
        KC_DOT,  KC_HASH,    KC_AT,  KC_EXLM,  KC_QUES,   KC_GRV,  _______,     _______,  KC_TILD,  KC_MINS,  KC_PLUS,   KC_EQL,  KC_PIPE,  KC_COMM,\
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
        KC_END,  KC_CIRC,  KC_AMPR,   KC_DLR,  KC_UNDS,   KC_DOT,  KC_LGUI,     KC_RGUI,  KC_COMM,  KC_PERC,  KC_ASTR,  KC_SLSH,  KC_BSLS,   KC_ENT,\
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
  ...
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
        KC_DOT,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,  _______,     _______,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,  KC_COMM,\
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
       _______,  KC_MNXT,  KC_VOLD,  KC_VOLU,  KC_MPLY,   KC_TAB,  KC_LGUI,     KC_RGUI,  KC_BSPC,  KC_LEFT,  KC_DOWN,    KC_UP,  KC_RGHT,  _______,\
  //|---------+---------+---------+---------+---------+---------+---------|  |---------+---------+---------+---------+---------+---------+---------|
